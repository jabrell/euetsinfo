...
| --- | --- | --- |
| [https://union-registry-data.ec.europa.eu/report/welcome](https://union-registry-data.ec.europa.eu/report/welcome) | The Union Registry page provides data on installations and compliance of units regulated under the EUETS together with allowance transactions. It also provides information on transactions under the Effort Sharing desicion | |
